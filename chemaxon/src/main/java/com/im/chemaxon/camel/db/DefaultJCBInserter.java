 ...
 * @author timbo
 */
public class DefaultJCBInserter extends JCBTableInserterUpdater {
    
    private static final Logger LOG = Logger.getLogger(DefaultJCBInserter.class.getName());

    private Map<String, Class> fieldDefs;

    public DefaultJCBInserter(String table, String extraCols, Map<String, Class> fieldDefs) {
