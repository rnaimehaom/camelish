...
public class ChemcentralDB extends DBDatabase {
    ...
    public static class Structures extends DBTable {
        ...
        public Structures(DBDatabase db) {
            super("STRUCTURES", db);
            CD_ID = addColumn("CD_ID", DataType.AUTOINC, 0, DataMode.AutoGenerated, "SQ_STRUCTURES");
    ...
    public static class Sources extends DBTable {
        ...
        public Sources(DBDatabase db) {
            super("SOURCES", db);
            // PROPERTY_ID
            ID = addColumn("ID", DataType.AUTOINC, 0, DataMode.AutoGenerated, "DEP_ID_SEQUENCE");
    ...
    public static class PropertyDefinitions extends DBTable {
        ...
        public PropertyDefinitions(DBDatabase db) {
            ...
            // PROPERTY_ID
            PROPERTY_ID = addColumn("PROPERTY_ID", DataType.AUTOINC, 0, DataMode.AutoGenerated, "DEP_ID_SEQUENCE");
