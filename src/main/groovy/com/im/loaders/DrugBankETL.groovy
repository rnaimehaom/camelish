...
class DrugBankETL extends AbstractETL {
    ...
    void generateSqls() {
        ...
        insertStructurePropsSql = """\
                ...
                |    FROM (SELECT cd_id, drugbank_id, drug_groups, generic_name, brands FROM vendordbs.drugbank_feb_2014) db
                |    JOIN vendordbs.drugbank_concordance con ON con.cd_id = db.cd_id""".stripMargin()
